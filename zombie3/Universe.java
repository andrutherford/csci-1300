...
public class Universe {
    ...
    public Universe(int iterations, int numTurtles, int numZombies, int w, int h)
    {
        StdDraw.setCanvasSize(w, h);
        StdDraw.setXscale(0, w);
        StdDraw.setYscale(0, h);
        
        currentDay = iterations;
    ...
    public void moveZombies()
    {
        ...
        for(int x = 0; x < N; x++)
        {
          ...
          {
        	  /*daysInfected[x]++;
        	  System.out.println(daysInfected[x]);
        	  if (daysInfected[x] == 4)
        	  {
        		  turtle[x].makeRecovered();
        		  System.out.println("Turtle " + x + "recovered.");
        	  }*/
          }
    ...
    public void zombieAttack(int q)
    {
                ...
                for(int x2 = xLow; x2 < xHigh; x2++)
                {
                    for(int y2 = yLow; y2 < yHigh; y2++)
                    {
                        ...
                        {                     	
                        	//********************
                        	//turtle[x].makeRecovered();
                        	//System.out.println("TURTLE " + x + " RECOVERED AND INFECTED TURTLE " + turtle[tLocations[x2][y2]]);
                        	//********************
